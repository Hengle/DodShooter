...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DodExperienceDefinition)

#define LOCTEXT_NAMESPACE "DodSystem"

#if WITH_EDITOR
EDataValidationResult UDodExperienceDefinition::IsDataValid(class FDataValidationContext& Context) const
{
...
void UDodExperienceDefinition::UpdateAssetBundleData()
{

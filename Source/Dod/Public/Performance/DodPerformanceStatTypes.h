...
#include "DodPerformanceStatTypes.generated.h"

UENUM(BlueprintType)
enum class EDodStatDisplayMode : uint8
{
...
ENUM_RANGE_BY_COUNT(EDodDisplayablePerformanceStat, EDodDisplayablePerformanceStat::Count);
